...
if (isset($_GET['method']) && $_GET['method']=='ban')
{
   
    $controleur->banSubordonnes($_GET['id_u']);
}
...
if(isset($_POST['sub']))
{
    ...
    $controleur->insertSalarie($email,$nom,$prenom,$lvl);
}

$lesSubordonnes=$controleur->allSubordonnes();
...
<div class="loader-bg">
	...
	<header class="navbar pcoded-header navbar-expand-lg navbar-light header-dark">
				...
				<div class="m-header">
					...
					<a href="index.php?method=logout">
						<button class="btn btn-warning"> log out</button>
					</a>
                    <a href="index.php?page=profil.php">
    ...
    <div class="pcoded-content">
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <form class="row g-3" method="POST">
                            <div class="col-auto">
                                <label for="inputPassword2">Recherche d'une formation</label>
                                <input name="search" type="form-control" class="form-control" id="inputPassword2" placeholder="Password">
                            </div>
                            <div class="col-auto">
                                <button name="submit_research" type="submit" class="btn btn-primary mb-3">Recherche</button>
                            </div>
                            </form>
                        <ul class="breadcrumb">
                        </ul>
        ...
        <div class="row">
                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table table-hover mb-0">
                                ...
                                {
                                    if($formation['etat']==1){
                                        $case="class='table-success'";
                                    }
                                    elseif($formation['etat']==2){
                                        $case="class='table-secondary'";
                                    }
                                    elseif($formation['etat']==3){
                                        $case="class='table-danger'";
                                    }
                                    else{
                                        $case="";
                                    }
                            ...
                            <table class="table table-hover mb-0">
                                ...
                                foreach($lesSalaries as $salarie)
                                {
                                    ...
                                    <tr>
                                        <td>
                                            <div>
                                                <a href="index.php?method=delete&id_u=<?= $salarie['id_u']; ?>">
            ...
            <div class="col-xl-6 col-md-12">
                <div class="card table-card">
                    <div class="card-header">
                        <h5>Utilisateurs Subordonnés</h5>
                        <div class="card-header-right">
                            <div class="btn-group card-option">
                                <button type="button" class="btn dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <i class="feather icon-more-horizontal"></i>
                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    <?php 
                                foreach($lesSubordonnes as $subordonne)
                                {
                                    ?>
                                    <tr <?php if($subordonne['lvl']==0)
                                            { echo "class='table-secondary'";}?> >
                                        <td>
                                            <div>
                                            <a href="index.php?method=ban&id_u=<?= $subordonne['id_u']; ?>">
                                            ...
                                            <td>
                                                <div>
                                                    <p><?= $subordonne['nom_u']?></p>
                                                </div>
                                            </td>
                                            <td>
                                                <div>
                                                    <p><?= $subordonne['prenom_u']?></p>
                                                </div>      
                                        </td>
...
<div class="mb-3">
  ...
  <input type="form-control" name="nom" class="form-control" id="exampleFormControlInput1" >
</div>
<div class="mb-3">
  <label for="exampleFormControlInput1" class="form-label">Prénom</label>
  <input type="form-control" name="prenom" class="form-control" id="exampleFormControlInput1">
</div>

<select class="form-select" aria-label="Default select example" name="statut">
  <option selected>Open this select menu</option>
  <option value="1">Subordonné</option>
